...
project.map((value, index) => {
  ...
  div.innerHTML = `
        <img class="w-full imgs max-h-[373.6px] border border-[#121212] border-t-0 border-r-0 md:border-l border-l-0"
          src="${value.img}" alt="error" >
        <h4
          class="absolute -bottom-[-25px] left-2/4 -translate-x-2/4 -translate-y-2/4 mb-1 font-medium text-base text-[#121212]">${value.name}
          </h4>
        <h4
